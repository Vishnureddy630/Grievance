...
def login():
    ...
    if type_user=="admin":
        try:
            my=mysql.connector.connect(host="sql7.freesqldatabase.com",user='sql7716759',password='Yb7GcYuU1K',database='sql7716759')
        ...
        try:
            ...
            error_message = 'Incorrect username or password. Please try again.'
            # error_message=got_username+got_password
            return render_template('login.html', error_message=error_message)
